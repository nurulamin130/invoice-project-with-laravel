...
<template>
    <div class="container">
            ...
            <div class="card__content">
                ...
                <div class="table">
                    ...
                    <div class="table--items2" v-for="(itemcart,i) in listcart" :key="itemcart.id">
                        ...
                        <p>
                            <input type="text" class="input" {{itemcart.unit_price}}>
                        </p>
                        <p>
                            <input type="text" class="input" {{itemcart.quantity}} >
                        </p>
                        <p v-if="itemcart.quantity">
                            ${{(itemcart.quantity)*(itemcart.unit_price)}}
                        </p>
                        <p style="color: #ff0000; font-size: 24px;cursor: pointer;" {{itemcart.item_code}}>
                            &times;
                        </p>
                        <p v-else></p>
                    </div>
        ...
        <!--==================== add modal items ====================-->
        <div class="modal main__modal " :class="{show : show}">
            <div class="modal__content">
                ...
                <div class="modal__items">
                    <li v-for="(item,i) in listproducts" :key="item.id" style="display: grid;grid-template-columns: 30px 350px 15px;align-items: center;padding-bottom: 5px">
                        <p>{{i+1}}</p>
                        <a href="#">{{item.item_code}}{{item.declaration}}</a>
                        <button @click="addCart(item)" style="width: 35px;height: 15px"></button>
                    </li>
                </div>
                <br><hr>
